...
from .views import HomeView, RegisterView, EditProfileView, DeleteProfileView, QuestionListView, QuestionDetailView, ResultsView, VoteView, profile
...
urlpatterns = [
    path('', HomeView.as_view(), name='home'),  # Главная страница с постами
